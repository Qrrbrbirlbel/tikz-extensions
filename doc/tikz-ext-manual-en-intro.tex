...
\begin{key}{/\tikzext/compat=\mchoice{pre 1.0, 1.0, warn, newest} (default pre 1.0)}
...
\begin{keylist}[/\tikzext/compat]{%
  pgfcalendar-ext=\meta{version} (default pre 1.0),
  arrows=\meta{version} (default pre 1.0),
  layers=\meta{version} (default pre 1.0),
  nodes=\meta{version} (default pre 1.0),
  node-families=\meta{version} (default pre 1.0),
  paths.arcto=\meta{version} (default pre 1.0),
  paths.ortho=\meta{version} (default pre 1.0),
  paths.timer=\meta{version} (default pre 1.0),
  pgffor-ext=\meta{version} (default pre 1.0),
  pgfkeys-plus=\meta{version} (default pre 1.0),
  positioning-plus=\meta{version} (default pre 1.0),
  scalepicture=\meta{version} (default pre 1.0),
  shapes=\meta{version} (default pre 1.0),
  transformations.mirror=\meta{version} (default pre 1.0),
  topaths.arcthrough=\meta{version} (default pre 1.0)%
}
