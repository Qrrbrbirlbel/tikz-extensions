...
\begin{key}{/tikz/full arc=\marg{num} (default |{}|)}
...
\begin{handler}{{.List}|=|\meta{\meta{e1}, \meta{e2}, ..., \meta{en}}}
...
\begin{key}{/pgf/foreach/use int=\meta{start}| to |\meta{end}| step |\meta{delta}}
...
\begin{key}{/pgf/foreach/use float=\meta{start}| to |\meta{end}| step |\meta{delta}}
