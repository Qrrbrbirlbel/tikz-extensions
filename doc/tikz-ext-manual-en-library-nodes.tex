...
Certain cases exist for |west|, |east|, |above| and |below| placements
where it is not clear how a node should be placed.
These cases and their behavior can be seen in the following diagram.
...
\tikz\matrix[nodes=draw, row sep=5mm, column sep=5mm, ampersand replacement=\&]{%
