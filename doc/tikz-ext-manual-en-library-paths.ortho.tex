...
\begin{stylekey}{/tikz/vertical horizontal}
  ...
  that can be used with the path operations |to| or |edge|.
\end{stylekey}
\begin{stylekey}{/tikz/horizontal vertical horizontal=\opt{\meta{options}}}
  This installs  \verb!to path = -|- (\tikztotarget) \tikztonodes!
  that can be used with the path operations |to| or |edge|.
\end{stylekey}
\begin{stylekey}{/tikz/vertical horizontal vertical=\opt{\meta{options}}}
  This installs  \verb!to path = |-| (\tikztotarget) \tikztonodes!
  that can be used with the path operations |to| or |edge|.
\end{stylekey}
\begin{stylekey}{/tikz/up horizontal down=\opt{\meta{options}}}
  This installs  \verb!to path = r-ud (\tikztotarget) \tikztonodes!
  that can be used with the path operations |to| or |edge|.
\end{stylekey}
\begin{stylekey}{/tikz/down horizontal up=\opt{\meta{options}}}
  This installs  \verb!to path = r-du (\tikztotarget) \tikztonodes!
  that can be used with the path operations |to| or |edge|.
\end{stylekey}
\begin{stylekey}{/tikz/left vertical right=\opt{\meta{options}}}
  This installs  \verb!to path = r-lr (\tikztotarget) \tikztonodes!
  that can be used with the path operations |to| or |edge|.
\end{stylekey}
\begin{stylekey}{/tikz/right vertical left=\opt{\meta{options}}}
