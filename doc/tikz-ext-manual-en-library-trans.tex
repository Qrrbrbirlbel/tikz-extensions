...
\begin{key}{/tikz/ext/xmirror=\meta{value or coordinate} (default 0pt)}\keycompat{tikz}
...
\begin{key}{/tikz/ext/ymirror=\meta{value or coordinate} (default 0pt)}\keycompat{tikz}
  Sets up a transformation that mirrors along a vertical line that goes through point $(0, \text{\meta{value}})$ or \meta{coordinate}.
\end{key}


\begin{key}{/tikz/ext/mirror x=\meta{coordinate} (default {(0,0)})}\keycompat{tikz}
...
\begin{key}{/tikz/ext/mirror y=\meta{coordinate} (default {(0,0)})}\keycompat{tikz}
  Similar to |ymirror|, this however uses the |xyz| coordinate system instead of the |canvas| system.
\end{key}


\begin{key}{/tikz/ext/mirror=\meta{point A}|--|\meta{point B}}\keycompat{tikz}
...
\begin{key}{/tikz/ext/Mirror=\meta{point A}\opt{|--|\meta{point B}}}\keycompat{tikz}
  Sets up a transformation that mirrors along a line that goes through \meta{point A} and \meta{point B}.
