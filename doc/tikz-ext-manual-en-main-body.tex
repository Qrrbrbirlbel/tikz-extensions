...
%}
%\includeonly{tikz-ext-manual-en-pgf-shapes}
\begin{document}
...
\tikzsetfigurename{PGF.shapes}\include{tikz-ext-manual-en-pgf-shapes}
\part{Utilities}
...
\newcommand*{\addShape}[1]{Added shape \texttt{#1} (PGF library \texttt{ext.shapes.#1}).}
