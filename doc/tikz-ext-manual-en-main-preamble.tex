...
\newcommand*{\referenceLibraryandIndexExt}[1]{\texttt{ext.#1}\indexLibraryExt{#1}}
...
\newcommand*{\indexPackageExt}[1]{%
  \begingroup
%    \originalExternals
    \index{#1-ext@\originalExternals{\originalprefix\protect\texttt{\original{#1-ext}} package\originalsuffix}}%
    \index{Packages and files!#1-ext@\originalExternals{\originalprefix\protect\texttt{\original{#1-ext}}\originalsuffix}}%
  \endgroup
}
\newcommand*{\indexLibraryExt}[1]{%
  \index{#1@\originalExternals{\originalprefix\protect\texttt{\original{ext.#1}} library\originalsuffix}}%
  \index{Libraries!ext.#1@\originalExternals{\originalprefix\protect\texttt{\original{ext.#1}}\originalsuffix}}%
}
