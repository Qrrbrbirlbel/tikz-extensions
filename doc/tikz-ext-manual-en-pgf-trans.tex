...
\begin{command}{\pgfexttransformxmirror\marg{value}}
...
\begin{command}{\pgfexttransformymirror\marg{value}}
  Sets up a transformation that mirrors along a horizontal line that goes through point $(0, \text{\meta{value})}$.
\end{command}

\begin{command}{\pgfexttransformmirror\marg{point A}\marg{point B}}
...
\begin{command}{\pgfextqtransformmirror\marg{point A}}
