...
\pgfdeclareshape{superellipse}{%
  ...
  \backgroundpath{%
    ...
    \pgfplotstreamstart
    \pgfplotstreampoint{\pgfqpoint{\xradius}{0pt}}% east
    \pgf@tempa
    \pgfplotstreampoint{\pgfqpoint{0pt}{\yradius}}% north
    \pgf@tempb
    \pgfplotstreampoint{\pgfqpoint{-\xradius}{0pt}}% west
    \pgf@tempc
    \pgfplotstreampoint{\pgfqpoint{0pt}{-\yradius}}% south
    \pgf@tempd
    \pgfplotstreamend
