...
%%% Compatibility
\pgfqkeys{/pgf/arrow keys}{radius/.style={/pgf/arrow keys/inset={#1}}} % should be removed after v1.0
\tikzextset{
  /tikz-ext/compat/add library={arrows}{pre 1.0},
  ...
  compat/arrows/warn/.append code={%
    \tikzextutil@compatwarning@key{arrows}{pre 1.0}{/pgf/@arrows decl/clone}{/tikz-ext/@arrows decl/clone}%
    \tikzextutil@compatwarning@key{arrows}{pre 1.0}{/pgf/@arrows decl/append setup code}{/tikz-ext/@arrows decl/append setup code}%
            ...
            \pgfdeclarearrow{%
              ...
              /tikz-ext/@arrows decl/append setup code/.expanded = {%
                \noexpand\tikzextutil@compatmaybewarning
                  {arrow tip '\tikzext@temp'}{'ext_\tikzext@temp'}{arrows = pre 1.0}%
              }%
            }
          }{}%
        }{}%
  ...
  compat/arrows/pre 1.0/.append code=%
