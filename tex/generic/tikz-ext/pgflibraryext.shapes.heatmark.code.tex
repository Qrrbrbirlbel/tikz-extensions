...
\tikzextset{
  ...
  compat/shapes/pre 1.0/.append style=/tikz/ext/compat/shapes.heatmark/pre 1.0,
  compat/shapes.heatmark/warn/.code={%
    \tikzextutil@compatwarning@valuekey{shapes}{pre 1.0}{/pgf/heatmark arc width}{/pgf/ext/heatmark arc width}%
    \tikzextutil@compatwarning@valuekey{shapes}{pre 1.0}{/pgf/heatmark arc sep}{/pgf/ext/heatmark arc sep}%
    \tikzextutil@compatwarning@valuekey{shapes}{pre 1.0}{/pgf/heatmark arc rings}{/pgf/ext/heatmark arc rings}%
    \tikzextutil@compatwarning@valuekey{shapes}{pre 1.0}{/pgf/heatmark arcs}{/pgf/ext/heatmark arcs}%
    \tikzextutil@compatwarning@valuekey{shapes}{pre 1.0}{/pgf/heatmark arc sep angle}{/pgf/ext/heatmark arc sep angle}%
    \tikzextutil@compatwarning@valuekey{shapes}{pre 1.0}{/pgf/heatmark inner opacity}{/pgf/ext/heatmark inner opacity}%
    \tikzextutil@compatwarning@valuekey{shapes}{pre 1.0}{/pgf/heatmark outer opacity}{/pgf/ext/heatmark outer opacity}%
    ...
    \def\tikzext@temp{\tikzextutil@compatmaybewarning{shape 'heatmark'}{'ext_heatmark'}{shapes = pre 1.0}}%
    \tikzextutil@prefix@macrotomacro\pgf@sh@s@heatmark\tikzext@temp
  },
  compat/shapes.heatmark/pre 1.0/.code={%
