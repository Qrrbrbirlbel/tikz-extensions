...
\tikzextset{
  ...
  compat/shapes/pre 1.0/.append style=/tikz/ext/compat/shapes.superellipse/pre 1.0,
  compat/shapes.superellipse/warn/.code={%
    \tikzextutil@compatwarning@key     {shapes}{pre 1.0}{/pgf/superellipse exponent}  {/pgf/ext/superellipse exponent}%
    \tikzextutil@compatwarning@valuekey{shapes}{pre 1.0}{/pgf/superellipse x exponent}{/pgf/ext/superellipse x exponent}%
    \tikzextutil@compatwarning@valuekey{shapes}{pre 1.0}{/pgf/superellipse y exponent}{/pgf/ext/superellipse y exponent}%
    \tikzextutil@compatwarning@valuekey{shapes}{pre 1.0}{/pgf/superellipse step}      {/pgf/ext/superellipse step}%
    ...
    \def\tikzext@temp{\tikzextutil@compatmaybewarning{shape 'superellipse'}{'ext_superellipse'}{shapes = pre 1.0}}%
    \tikzextutil@prefix@macrotomacro\pgf@sh@s@superellipse\tikzext@temp
  },
  compat/shapes.superellipse/pre 1.0/.code={%
