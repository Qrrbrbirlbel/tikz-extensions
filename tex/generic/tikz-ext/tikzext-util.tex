...
\pgfutil@for\tikzext@temp:=pre 0.6,0.6,newest,warn\do{%
  \pgfkeysedef{/tikz/ext/compat/\tikzext@temp}{%
    ...
    \noexpand\pgfkeyssetvalue{/tikz/ext/compat/pgffor}                {\tikzext@temp}%
    ...
    \noexpand\pgfkeyssetvalue{/tikz/ext/compat/paths.ortho}           {\tikzext@temp}%
    \noexpand\pgfkeyssetvalue{/tikz/ext/compat/paths.timer}           {\tikzext@temp}%
    \noexpand\pgfkeyssetvalue{/tikz/ext/compat/positioning-plus}      {\tikzext@temp}%
    ...
    \noexpand\pgfkeyssetvalue{/tikz/ext/compat/shapes}                {\tikzext@temp}%
