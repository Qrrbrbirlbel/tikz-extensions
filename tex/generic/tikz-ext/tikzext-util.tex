...
\def\tikzextversion{0.7}
\def\tikzextversionnumber{12}
...
\tikzextset{
  ...
  /tikz-ext/compat/add library*/.code n args={3}{%
    \pgfkeysifdefined{/tikz/ext/compat/#2/.@cmd}{}{%
      \pgfkeysalso{/tikz-ext/compat/add library={#2}{#3}}%
    }%
    \tikzextset{%
      compat/#2/pre 0.6/.append style=/tikz/ext/compat/#1/pre 0.6/.try,
      compat/#2/0.6/.append style=/tikz/ext/compat/#1/0.6/.try,
      compat/#2/warn/.append style=/tikz/ext/compat/#1/warn/.try,
      compat/#2/newest/.append style=/tikz/ext/compat/#1/newest/.try,
    }%
  }
}
...
\let\pgfextutil@addto@macro\tikzextutil@addto@macro
