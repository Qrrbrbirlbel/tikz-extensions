...
\tikzextset{
  ext/beamer/alt/.code args={#1#2#3}{\alt<#1>{\pgfkeysalso{#2}}{\pgfkeysalso{#3}}},
  ...
  beamer function/only/.code     =\let\tikzext@beamerfunction\tikzext@beamerfunction@only,
  ...
  ext/uncover'/.style  ={/tikz/ext/cover={#1}},
  ext/visible'/.style  ={/tikz/ext/invisible={#1}},
  ext/cover'/.style    ={/tikz/ext/uncover={#1}},
  ext/invisible'/.style={/tikz/ext/visible={#1}},
  /handlers/.ext_</.code=\tikzext@beamer@handler#1\pgf@stop,
  beamer shortcuts/.code=\pgfqkeys{/tikz/ext/beamer shortcuts}{#1},
  beamer shortcuts/first char/.initial=uncover, % or visible
...
\pgfqkeys{/tikz/graphs}{
  ext/uncover/.style={/tikz/graphs/@edges styling/.append={,/tikz/ext/uncover={#1}}},
  ext/visible/.style={/tikz/graphs/@edges styling/.append={,/tikz/ext/visible={#1}}},
  ext/cover/.style={/tikz/graphs/@edges styling/.append={,/tikz/ext/cover={#1}}},
  ext/invisible/.style={/tikz/graphs/@edges styling/.append={,/tikz/ext/invisible={#1}}},
}
