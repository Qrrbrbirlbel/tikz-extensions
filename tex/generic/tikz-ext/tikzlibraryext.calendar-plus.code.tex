...
\tikzextset{
  compat/pgfcalendar-ext/warn/.append code={%
    \tikzextutil@compatwarning@cmd{calendar-plus}{pre 1.0}{pgfmathlastdayinmonthofyear}\pgfmathextlastdayinmonthofyear\tikzextutil@gobblethree
    \tikzextutil@compatwarning@cmd{calendar-plus}{pre 1.0}{pgfmathweeksinmonthofyear}\pgfmathextweeksinmonthofyear\pgfutil@gobbletwo
    \pgfutil@for\tikzext@temp:=Jan,Feb,Mar,Apr,May,Jun,Jul,Aug,Sep,Oct,Nov,Dec,%
      ...
      \pgfkeys@expanded{\noexpand\tikzextutil@compatwarning@key
        {pgfcalendar-ext}{pre 1.0}{/pgf/calendar/\tikzext@temp}{/pgf/calendar/ext/\tikzext@temp}%
      }%
    }%
    ...
    \pgfkeyssetvalue{/pgf/calendar/calendar week of month'/.@def}{1}%
    \tikzextutil@compatwarning@cmd{pgfcalendar-ext}{pre 1.0}
      {pgfcalendarjulianyeartoweek}\pgfextcalendarjulianyeartoweek\tikzextutil@gobblethree
  },
  compat/pgfcalendar-ext/pre 1.0/.append code={%
    \pgfutil@for\tikzext@temp:=Jan,Feb,Mar,Apr,May,Jun,Jul,Aug,Sep,Oct,Nov,Dec,%
      leap year,and,not,week of month,week of month',calendar week of month,%
      calendar week of month',yesterday,week\do{%
