...
%%% Compatibility
\tikzextset{
  /tikz-ext/compat/add library={misc}{pre 1.0},
  compat/misc/warn/.append code={%
    \tikzextutil@compatwarning@key{misc}{pre 1.0}{/pgf/full arc}{/pgf/ext/full arc}%
    \tikzextutil@compatwarning@mathcmdII{misc}{pre 1.0}{strrepeat}{extstrrepeat}%
    \tikzextutil@compatwarning@mathcmdII{misc}{pre 1.0}{isInString}{extisInString}%
    \ifcsname pgfmathstrcat@\endcsname\else
      \let\pgfmathextstrcat@noforest\relax
      \tikzextutil@compatwarning@mathcmdX{misc}{pre 1.0}{strcat}{extstrcat}%
    \fi
    \tikzextutil@compatwarning@mathcmdI{misc}{pre 1.0}{isEmpty}{extisEmpty}%
    \tikzextutil@compatwarning@mathcmdII{misc}{pre 1.0}{atanXY}{extatanXY}%
    \tikzextutil@compatwarning@mathcmdII{misc}{pre 1.0}{atanYX}{extatanYX}%
    \tikzextutil@compatwarning@mathcmdII{misc}{pre 1.0}{anglebetween}{extanglebetween}%
    \tikzextutil@compatwarning@mathcmdII{misc}{pre 1.0}{distancebetween}{extdistancebetween}%
    \tikzextutil@compatwarning@mathcmdI{misc}{pre 1.0}{qanglebetween}{extqanglebetween}%
    \tikzextutil@compatwarning@mathcmdI{misc}{pre 1.0}{qdistancebetween}{extqdistancebetween}%
  },
  compat/misc/pre 1.0/.append code={%
