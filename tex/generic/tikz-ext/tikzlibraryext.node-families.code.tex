...
%   \input memoizable.tex
% \fi
% \ifpgfutil@format@is@context
%   \pgfutil@usemodule{memoizable}
% \fi

\pgfutil@IfUndefined{mmzAbort}{\let\tikzext@mmzAbort\relax}{\let\tikzext@mmzAbort\mmzAbort}
...
\def\tikzext@nf@save#1{%
  \pgfutil@IfUndefined{tikzext@nf@#1@previous}{%
    ...
    \expandafter\ifx\csname tikzext@nf@#1@previous\expandafter\endcsname
