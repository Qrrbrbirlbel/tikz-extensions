...
\def\tikzext@nodepicture@callback@#1{%
  ...
  \begingroup
    ...
    \pgftransformshift{\pgfqpoint{-\csname pgf@lbb@minx@tikzext@nodepicture\the\tikzext@nodepicture\endcsname}{0pt}}
...
\def\tikzext@nodepicture@callback@special#1#2{%
  \ifnum\tikzext@nodepicture>\pgfinteval{#1-1}
  ...
  \else
    \unless\ifcsname tikzext@nodepicture@#2-#1@visited\endcsname
      ...
      \endgroup
      \ifnum#1>1
        \xdef\tikzext@nodepicture@list{\tikzext@nodepicture@list,{\pgfinteval{#1-1}}{#2}}%
      \fi
    \fi
  \fi
}
...
\def\tikzextnodepicture{\pgfinteval{\tikzext@nodepicture-1}}%
        ...
        \pgfinterruptboundingbox
          ...
          \bgroup
            \expandafter\def\csname pgf@sh@np@current bounding box\endcsname{%
              \def\southwest{\pgfqpoint{\csname pgf@lbb@minx@tikzext@nodepicture\pgfinteval{\tikzext@nodepicture-1}\endcsname}%
                                       {\csname pgf@lbb@miny@tikzext@nodepicture\pgfinteval{\tikzext@nodepicture-1}\endcsname}}%
              \def\northeast{\pgfqpoint{\csname pgf@lbb@maxx@tikzext@nodepicture\pgfinteval{\tikzext@nodepicture-1}\endcsname}%
                                       {\csname pgf@lbb@maxy@tikzext@nodepicture\pgfinteval{\tikzext@nodepicture-1}\endcsname}}%
            }%
...
\def\tikzext@nodepicture@done{
  ...
  \setbox\pgfnodeparttextbox=\hbox{%
    \kern-\csname pgf@lbb@minx@tikzext@nodepicture\the\tikzext@nodepicture\endcsname
    \lower\tikzext@nodepicture@baseline@\relax
    \box\pgfnodeparttextbox
    \kern\csname pgf@lbb@maxx@tikzext@nodepicture\the\tikzext@nodepicture\endcsname
  }%
  \pgf@ya=\csname pgf@lbb@maxy@tikzext@nodepicture\the\tikzext@nodepicture\endcsname\relax
  \advance\pgf@ya by -\tikzext@nodepicture@baseline@
  \ht\pgfnodeparttextbox=+\pgf@ya
  \pgf@ya=-\csname pgf@lbb@miny@tikzext@nodepicture\the\tikzext@nodepicture\endcsname\relax
  \advance\pgf@ya by \tikzext@nodepicture@baseline@
...
\pgfqkeys{/tikz/ext/node picture}{
  .is choice,
  true/.code=\tikz@node@is@picfalse\tikz@is@matrixfalse\tikz@fig@mustbenamed\let\tikz@do@fig\tikzext@nodepicture@do,
