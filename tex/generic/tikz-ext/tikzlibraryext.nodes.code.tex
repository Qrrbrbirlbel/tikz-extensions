...
\def\tikzext@nodepic@callback#1{\xdef\tikzext@nodepic@list{\tikzext@nodepic@list,{#1}}}
...
\pgfqkeys{/tikz/ext}{
  ...
  node is pic/true/.code=\tikz@node@is@picfalse\tikz@is@matrixfalse\tikz@fig@mustbenamed\let\tikz@do@fig\tikzext@do@nodeispic,
