...
\def\tikzext@nodepicture@callback@#1{%
  ...
  \begingroup
    ...
    \pgftransformshift{\pgfqpoint{-\tikzext@nodepicture@minx@g}{0pt}}% TODO which x?
...
\def\tikzext@nodepicture@do{%
  ...
  \fi
  \tikz@fig@mustbenamed
  \let\tikzext@nodepicture@baseline@save\tikzext@nodepicture@baseline
    ...
    \pgfinterruptpath
      \pgfscope
        \pgfinterruptboundingbox
          ...
          \pgfkeysvalueof{/tikz/ext/every node picture/.@cmd}\the\tikzext@nodepicture\pgfeov
          \pgfkeysvalueof{/tikz/ext/node picture/at start/.@cmd}\the\tikzext@nodepicture\pgfeov
          \bgroup
            \aftergroup\tikzext@nodepicture@done
}
\def\tikzext@nodepicture@done{%
          \pgfkeysvalueof{/tikz/ext/node picture/at end/.@cmd}\the\tikzext@nodepicture\pgfeov
          \ifx\tikzext@nodepicture@baseline\pgfutil@empty
          ...
          \else
            ...
            \expandafter\tikzext@temp\tikzext@nodepicture@baseline\relax
          \fi
          \iftikzext@nodepicture@ilw
            \xdef\tikzext@gtemp{%
              \def\noexpand\tikzext@nodepicture@minx{\csname pgf@lbb@minx@tikzext@nodepicture\the\tikzext@nodepicture\endcsname}%
              \def\noexpand\tikzext@nodepicture@miny{\csname pgf@lbb@miny@tikzext@nodepicture\the\tikzext@nodepicture\endcsname}%
              \def\noexpand\tikzext@nodepicture@maxx{\csname pgf@lbb@maxx@tikzext@nodepicture\the\tikzext@nodepicture\endcsname}%
              \def\noexpand\tikzext@nodepicture@maxy{\csname pgf@lbb@maxy@tikzext@nodepicture\the\tikzext@nodepicture\endcsname}%
            }%
          \else
            \xdef\tikzext@gtemp{%
    ...
    \endpgfinterruptpath
  \egroup
  \global\let\tikzext@nodepicture@baseline\tikzext@nodepicture@baseline@save
  %
  \tikzext@gtemp
  \ifdim\tikzext@nodepicture@maxx=-16000pt
    \tikzext@nodepicture@minx=0pt
    \tikzext@nodepicture@maxx=0pt
    \tikzext@nodepicture@miny=0pt
    \tikzext@nodepicture@maxy=0pt
  \fi
...
\pgfutil@namedef{pgf@sh@ns@current node picture bounding box}{rectangle}
\pgfutil@namedef{pgf@sh@np@current node picture bounding box}{%
...
\pgfutil@namedef{pgf@sh@nt@current node picture bounding box}{{1}{0}{0}{1}{0pt}{0pt}}
\pgfutil@namedef{pgf@sh@pi@current node picture bounding box}{\pgfpictureid}

\tikzextset{
  node picture/.code=\pgfqkeys{/tikz/ext/node picture}{#1},
  node picture/.default=true,
  node picture/true/.code=\tikz@node@is@picfalse\tikz@is@matrixfalse\tikz@fig@mustbenamed\let\tikz@do@fig\tikzext@nodepicture@do,
  node picture/false/.code=\let\tikz@do@fig\tikzextorig@tikz@do@fig,
  node picture/ignore line width/.is if=tikzext@nodepicture@ilw
}
\pgfkeysdef{/tikz/ext/every node picture}{}
\pgfkeysdef{/tikz/ext/node picture/at start}{}
\pgfkeysdef{/tikz/ext/node picture/at end}{}
\pgfkeysdef{/tikz/ext/node picture/baseline}{\gdef\tikzext@nodepicture@baseline{#1}}
\global\let\tikzext@nodepicture@baseline\pgfutil@empty
