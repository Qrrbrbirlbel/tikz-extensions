...
\pgfkeysdefnargs{/tikz/ext/node picture/add anchor west}{2}{\edef\tikzext@nodepicture@anchors@list{\tikzext@nodepicture@anchors@list,{#1}{#2}{-1}{0}}}
\pgfkeysdefnargs{/tikz/ext/node picture/add anchor east}{2}{\edef\tikzext@nodepicture@anchors@list{\tikzext@nodepicture@anchors@list,{#1}{#2}{1}{0}}}
\pgfkeysdefnargs{/tikz/ext/node picture/add anchor north}{2}{\edef\tikzext@nodepicture@anchors@list{\tikzext@nodepicture@anchors@list,{#1}{#2}{0}{1}}}
\pgfkeysdefnargs{/tikz/ext/node picture/add anchor south}{2}{\edef\tikzext@nodepicture@anchors@list{\tikzext@nodepicture@anchors@list,{#1}{#2}{0}{-1}}}
...
\pgfkeysdef{/tikz/ext/node picture/reset graphic state}{%
  \pgfkeysaddvalue{/tikz/ext/node picture/at start}{%
      \tikzset{
        /tikz/color=black,
        /tikz/arrows=-,
        /tikz/solid,
...
\def\tikzext@nodepicture@doanchors#1#2#3#4{%
  ...
  \ifx\tikzext@nodepicture@anchorslist\pgfutil@empty
    \edef\tikzext@temp{{#1}{\noexpand\pgfqpoint{\the\pgf@x}{\the\pgf@y}}}%
  \else
    \edef\tikzext@temp{{#1}{\noexpand\pgfqpoint{\the\pgf@x}{\the\pgf@y}}}%
  \fi
...
\def\tikzext@nodepicture@done{%
          ...
          \else
            \def\tikz@anchor{text}%
            \expandafter\tikz@scan@one@point\expandafter\tikzext@nodepicture@shift\expandafter(\expandafter{\tikzext@nodepicture@anchor@save})\relax
          \fi
