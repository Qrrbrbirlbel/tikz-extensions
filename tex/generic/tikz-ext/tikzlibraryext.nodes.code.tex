...
\def\tikzext@nodepicture@done{%
          ...
          \fi
          \pgfkeysgetvalue{/tikz/ext/node picture/anchor}{\tikzext@temp}%
          \ifx\tikzext@temp\pgfutil@empty
            \let\tikzext@nodepicture@shift@\pgfutil@empty
          \else
            \def\tikz@anchor{text}%
            \expandafter\tikz@scan@one@point\expandafter\tikzext@nodepicture@shift\expandafter(\expandafter{\tikzext@temp})\relax
          \fi
          \iftikzext@nodepicture@ilw
            \xdef\tikzext@gtemp{%
              \def\noexpand\tikzext@nodepicture@shift@{\expandafter\noexpand\tikzext@nodepicture@shift@}%
...
\tikzextset{
  ...
  node picture/enable/.style=/tikz/ext/node picture/true,
  node picture/disable/.style=/tikz/ext/node picture/false,
