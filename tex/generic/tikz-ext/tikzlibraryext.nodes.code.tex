...
\def\tikzext@picturenode@done{
  ...
  \ht\pgfnodeparttextbox=+\csname pgf@lbb@maxy@tikzext@picturenode\the\tikzext@picturenode\endcsname\relax
  \dp\pgfnodeparttextbox=-\csname pgf@lbb@miny@tikzext@picturenode\the\tikzext@picturenode\endcsname\relax
  \tikz@fig@continue
}
