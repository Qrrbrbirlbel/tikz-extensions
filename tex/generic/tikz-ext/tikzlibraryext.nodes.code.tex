...
%%% Compatibility
\tikzextset{
  /tikz-ext/compat/add library={nodes}{pre 1.0},
  compat/nodes/warn/.append code=%
    % \pgfkeyssetvalue{/tikz/ext/compat/nodes@}{3}%
    \tikzextutil@compatwarning@key{nodes}{pre 1.0}{/tikz/pic}            [true]{/tikz/ext/pic}%
    \tikzextutil@compatwarning@key{nodes}{pre 1.0}{/tikz/node on line}   []    {/tikz/ext/node on line}%
    \tikzextutil@compatwarning@key{nodes}{pre 1.0}{/tikz/nodes on line}        {/tikz/ext/nodes on line}%
    \tikzextutil@compatwarning@key{nodes}{pre 1.0}{/tikz/nodes on curve} []    {/tikz/ext/nodes on curve}%
    \tikzextutil@compatwarning@key{nodes}{pre 1.0}{/tikz/nodes on curve'}[]    {/tikz/ext/nodes on curve'},
  compat/nodes/pre 1.0/.append code=%
    ...
    \pgfkeyssetvalue{/tikz/nodes on curve'/.@def}{},
  % compat/nodes/1.0/.append code=\pgfkeyssetvalue{/tikz/ext/compat/nodes@}{1},
