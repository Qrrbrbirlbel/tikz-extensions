...
\pgfutil@namedef{pgf@sh@nt@current bounding box}{{1}{0}{0}{1}{0pt}{0pt}}
\pgfutil@namedef{pgf@sh@pi@current bounding box}{\pgfpictureid}

\tikzextset{
  node picture/.is choice,
...
\pgfkeysdef{/tikz/ext/baseline}{\gdef\tikzext@nodepicture@baseline{#1}}
