...
\tikzset{
  ...
  ortho/install shortcuts/.style={
    *|/.style={/tikz/only vertical   second={##1}}, *|/.default=,
    |*/.style={/tikz/only vertical   first={##1}},  |*/.default=,
    *-/.style={/tikz/only horizontal second={##1}}, *-/.default=,
    -*/.style={/tikz/only horizontal first={##1}},  -*/.default=,
    |-/.style={/tikz/to path={|-(\tikztotarget)\tikztonodes}},
    -|/.style={/tikz/to path={-|(\tikztotarget)\tikztonodes}},
    -|-/.style={/tikz/horizontal vertical horizontal={##1}}, -|-/.default=,
    |-|/.style={/tikz/vertical   horizontal vertical={##1}}, |-|/.default=,
    r-du/.style={/tikz/down horizontal up={##1}}, r-du/.default=,
    r-ud/.style={/tikz/up horizontal down={##1}}, r-ud/.default=,
    r-rl/.style={/tikz/right vertical left={##1}}, r-rl/.default=,
    r-lr/.style={/tikz/left vertical right={##1}}, r-lr/.default=%
  },
  ...
  horizontal vertical horizontal/.style={to path={-|-[{#1}](\tikztotarget)\tikztonodes}},
  vertical horizontal vertical/.default=
  vertical horizontal vertical/.style={to path={|-|[{#1}](\tikztotarget)\tikztonodes}},
  right vertical left/.default=,
  right vertical left/.style={to path={r-rl[{#1}](\tikztotarget)\tikztonodes]}},
  left vertical right/.default=,
  left vertical right/.style={to path={r-lr[{#1}](\tikztotarget)\tikztonodes]}},
  up horizontal down/.default=,
  up horizontal down/.style={to path={r-ud[{#1}](\tikztotarget)\tikztonodes]}},
  down horizontal up/.default=,
  down horizontal up/.style={to path={r-du[{#1}](\tikztotarget)\tikztonodes]}},
