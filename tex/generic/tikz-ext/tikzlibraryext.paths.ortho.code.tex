...
\def\tikzext@ortho@hvh@do#1{%
  ...
  \begingroup
    \tikzextset{ortho/.expand once=\tikzext@ortho@options}%
    \iftikz@shapeborder
...
\def\tikzext@ortho@uddu@do#1#2#3#4{%
 \edef\tikz@timer@start{\noexpand\pgfqpoint{\the\tikz@lastx}{\the\tikz@lasty}}%
  ...
  \begingroup
    \tikzextset{ortho/.expand once=\tikzext@ortho@options}%
    \pgfmathsetlength\tikzext@tikz@udlr@distance{\pgfkeysvalueof{/tikz/ext/ortho/#3 distance}}%
    \iftikz@shapeborder
      \advance\pgf@y#21pt%
      ...
      \ifdim\pgf@yc#4\pgf@y
        ...
        \fi
      \fi
      \advance\pgf@yc#2\tikzext@tikz@udlr@distance
    ...
    \else
      ...
      \advance\pgf@yb#2\tikzext@tikz@udlr@distance
      \pgf@yc\pgf@yb
      \edef\pgf@temp{\noexpand\pgfqpoint{\the\tikz@lastx}{\the\tikz@lasty}}%
    \fi
    \edef\tikzext@temp{%
  ...
  \begingroup
    ...
    \iftikz@shapeborder
      ...
      \ifdim\pgf@xc#4\pgf@x
        ...
        \fi
      \fi
      \advance\pgf@xc#2\tikzext@tikz@udlr@distance
      \edef\pgf@temp{\noexpand\pgfqpoint{\the\pgf@x}{\the\pgf@y}}%
    \else
      \let\tikz@shapeborder@name\pgfutil@empty
      \ifx\pgf@temp\relax\else
      ...
      \advance\pgf@xb#2\tikzext@tikz@udlr@distance
      \pgf@xc\pgf@xb
      \edef\pgf@temp{\noexpand\pgfqpoint{\the\tikz@lastx}{\the\tikz@lasty}}%
    \fi
    \edef\tikzext@temp{%
