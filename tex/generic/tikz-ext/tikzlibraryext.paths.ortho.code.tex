...
\tikzextset{
  ...
  compat/paths.ortho/warn/.append code={%
    \pgfutil@for\tikzext@temp:=ratio,distance,from center,spacing,middle 0 to 1,%
      ud distance,du distance,lr distance,rl distance,udlr distance,%
      ...
      install shortcuts\do{%
      \pgfkeys@expanded{\noexpand\tikzextutil@compatwarning@key
        {paths.ortho}{pre 0.6}{/tikz/ortho/\tikzext@temp}{/tikz/ext/ortho/\tikzext@temp}%
      }%
    }%
  },
  compat/paths.ortho/pre 0.6/.append code={%
    \pgfutil@for\tikzext@temp:=ratio,distance,from center,spacing,middle 0 to 1,%
        ...
        only horizontal second,only vertical first,only horizontal first,%
        install shortcuts\do{%
      \pgfkeysedef{/tikz/ortho/\tikzext@temp}{%
        \noexpand\pgfkeysvalueof{/tikz/ext/ortho/\tikzext@temp/.@cmd}##1\noexpand\pgfeov
      }%
    }%
  },
