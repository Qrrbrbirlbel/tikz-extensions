...
\tikzextset{
  ...
  /tikz-ext/compat/add library={paths.timer}{pre 1.0},
  compat/paths.timer/warn/.append code=%
    \tikzextutil@compatwarning@key{paths.timer}{pre 1.0}{/tikz/rectangle timer}{/tikz/ext/rectangle timer},
  compat/paths.timer/pre 1.0/.append code=%
