...
\pgfutil@IfUndefined{mmzAbort}{%
  \let\tikzext@sp@mmzAbort\relax
  \let\tikzext@sp@mmzSetContext\pgfutil@gobble
  \let\tikzext@sp@mmzNoAbort\tikzext@sp@write
}{%
  \let\tikzext@sp@mmzAbort\mmzAbort
  \def\tikzext@sp@mmzSetContext#1{\pgfkeysvalueof{/mmz/context/.@cmd}#1\pgfeov}%
  \let\tikzext@sp@mmzNoAbort\relax
}
