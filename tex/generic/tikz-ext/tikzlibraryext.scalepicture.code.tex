...
\tikzextset{
  ...
  /tikz-ext/compat/warn=%
    {/tikz}
    {picture width,minimum picture width,maximum picture width,%
     picture height,minimum picture height,maximum picture height,%
     picture size,minimum picture size,maximum picture size,%
     picture width*,minimum picture width*,maximum picture width*,%
     picture height*,minimum picture height*,maximum picture height*,%
     picture size*}%
    {scalepicture}{pre 0.6},
