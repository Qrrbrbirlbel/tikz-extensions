...
\tikzextset{
  ...
  compat/pre 0.6/.append style=/tikz/ext/compat/scalepicture/pre 0.6,
  compat/scalepicture/pre 0.6/.code=%
    ...
    \pgfkeysdef{/tikz/maximum picture height*}{\pgfkeysvalueof{/tikz/ext/maximum picture height*/.@cmd}##1\pgfeov}%
    \pgfkeysdef{/tikz/picture size*}          {\pgfkeysvalueof{/tikz/ext/picture size*/.@cmd}##1\pgfeov}%
    \pgfkeysdef{/tikz/ext/compat/scalepicture/pre 0.6}{},
  compat/scalepicture/\pgfkeysvalueof{/tikz/ext/compat/scalepicture}/.try,
}
\endinput