...
%%% Compatibility
\tikzextset{
  /tikz-ext/compat/warn=%
    {/tikz}
    {xmirror,ymirror,mirror x,mirror y,mirror,xMirror,yMirror,Mirror x,Mirror y,Mirror}
    {transformations.mirror}{pre 0.6},
  compat/transformations.mirror/pre 0.6/.append code=%
    ...
    \pgfkeysdef{/tikz/Mirror y}{\pgfkeysvalueof{/tikz/ext/Mirror y/.@cmd}##1\pgfeov}%  
    \pgfkeysdef{/tikz/Mirror}  {\pgfkeysvalueof{/tikz/ext/Mirror/.@cmd}##1\pgfeov},
  compat/transformations.mirror/\pgfkeysvalueof{/tikz/ext/compat/transformations.mirror}/.try
}
\endinput
