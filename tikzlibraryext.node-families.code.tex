...
\pgfparserdef{tikzext-nodefamilies}{initial}l{%
  ...
  \pgfkeysalso{/tikz/column \the\c@pgf@counta/.append code=%
    \pgfqkeys{/tikz/node family}{
      text width align=left,
      text width=@tikzext@matrix@}}%
}
\pgfparserdef{tikzext-nodefamilies}{initial}r{%
  \advance\c@pgf@counta by 1
  \pgfkeysalso{/tikz/column \the\c@pgf@counta/.append code=%
    \pgfqkeys{/tikz/node family}{
      text width align=right,
      text width=@tikzext@matrix@}}%
}
\pgfparserdef{tikzext-nodefamilies}{initial}c{%
  \advance\c@pgf@counta by 1
  \pgfkeysalso{/tikz/column \the\c@pgf@counta/.append code=%
    \pgfqkeys{/tikz/node family}{
...
\pgfparserdef{tikzext-nodefamilies}{initial}*[mm]{%
  \begingroup
...
\pgfparserdef{tikzext-nodefamilies}{initial}\tikzext@stop{\pgfparserswitch{final}}
...
\pgfqkeys{/tikz/node family}{
  ...
  matrix columns/.code={%
    \c@pgf@counta=0
    \pgfparserparse{tikzext-nodefamilies}#1\tikzext@stop
    \pgfqkeys{/tikz/node family}{
      prefix/.append=\tikzmatrixname-\the\pgfmatrixcurrentcolumn,
    }%
  },
