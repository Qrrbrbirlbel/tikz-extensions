...
\tikzset{
  ...
  family text width algin/right/.code=\let\tikz@nf@align@action\tikz@nf@align@right,
  family text width align=left,
  family text width/.code={%
    \pgfkeyssetevalue{/tikz/family text@value}{#1}%
  }%
}
\def\tikz@nf@align@left#1{\usebox#1\hfil}
\def\tikz@nf@align@center#1{\hfil\usebox#1\hfil}
\def\tikz@nf@align@right#1{\usebox#1\hfil}
...
\pgfdeclareshape{Rectangle}{%
  \savedanchor\northeast{%
    ...
    % Qrr: family width
    \tikz@nf@getandset{\the\pgf@x}{width}{\pgfutil@tempa}%
    \ifdim\pgf@x<\pgfutil@tempa
      \pgf@x=\pgfutil@tempa
    \fi
    %
    ...
    % Qrr: family height
    \tikz@nf@getandset{\the\pgf@y}{height}{\pgfutil@tempa}%
    \ifdim\pgf@y<\pgfutil@tempa
      \pgf@y=\pgfutil@tempa
    \fi
    %
